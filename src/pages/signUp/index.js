                ...
                <div className="content-wrapper">
                    <div className="form-wrapper">
                        ...
                        <div className="form">
                            ...
                            <Input type="withIcon" icon="user" placeholder="Username"></Input>
                            ...
                            <div className="agreement">
                                ...
                                <p>I certify that I am 18 years of age or older, and I agree to the <Link>User Agreement</Link> and <Link>Privacy Policy</Link>. </p>
                            </div>
                            <Button text="Create account" type="green large"/>
                        </div>
                        <Link to={{pathname: "/signIn"}}><p>Already have an account?</p></Link>
                    </div>
                </div>
            </div>
        );
